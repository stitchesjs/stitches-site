        ...
        <Link sx={{ color: 'inherit', display: 'inline-flex', ':focus': { boxShadow: 'none' } }}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
            <g clip-path="url(#clip0)">
              <rect x="10.6066" y="18.3848" width="11" height="29" rx="5.5" transform="rotate(-45 10.6066 18.3848)" stroke="black" stroke-width="2"/>
              <rect x="10.6066" y="31.1127" width="29" height="11" rx="5.5" transform="rotate(-45 10.6066 31.1127)" fill="white" stroke="black" stroke-width="2"/>
              <path d="M16.9707 29.6985H22.6276M19.7991 32.5269V26.8701" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M21.9204 24.7487H27.5773M24.7488 27.5771V21.9203" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M26.8701 19.799H32.527M29.6985 22.6274V16.9705" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
            </g>
            <defs>
            <clipPath id="clip0">
