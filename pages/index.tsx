      ...
      <Container size={2} mt={8}>
        <Grid sx={{ gap: [6, 7], gridTemplateColumns: ['1fr ', '1fr 1fr'] }}>
          ...
          <Box>
            ...
            <Text as="p" size={3} sx={{ lineHeight: 2, color: 'gray700', pl: 7, ml: 1 }}>
              Each CSS property, given the same screen, pseudo and value is considered the same, giving high degree of reusability.
            </Text>
          </Box>
          ...
          <Box>
            ...
            <Text as="p" size={3} sx={{ lineHeight: 2, color: 'gray700', pl: 7, ml: 1 }}>
              AKA Critical Path CSS. You can compose your styles outside of your UI, but no injection happens until it is actually used. Only used variants are injected
            </Text>
          </Box>
