...
To use tokens you now prefix them with a `$`.
...
If you want to chain pseudo-classes or pseudo-elements you now use the `&` qualifier.
...
If for some reason you need to increase the specificity, we recommend doing it via an the class attribute selector:
