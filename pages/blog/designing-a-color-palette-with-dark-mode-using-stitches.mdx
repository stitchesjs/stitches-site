...
#### Steps 1–4: Backgrounds
 ...
 We need a gray for very subtle backgrounds. It might be a sidebar or a code block. `hsl(208, 12%, 92%)`
...
<Text as="figcaption" size="3" css={{ color: '$gray600' }}>An image doing this that or th eother.</Text>
