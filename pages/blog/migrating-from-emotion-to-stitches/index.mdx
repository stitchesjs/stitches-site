...
<Image title="Hero image of migrating from Emotion to Stitches" src={hero} size="hero" />
...
In Emotion, you can import the `styled` function directly from `@emotion/styled`.
...
Emotion generates Object-Oriented CSS. In other words, it will create a CSS rule per component, containing all of its necessary properties.
