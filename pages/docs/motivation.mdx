---
title: 'Motivation'
nextId: 'docs/installation'
---

Interop is a lightweight and performant CSS-in-JS library.

Designed with theming, variants and composition at its core, Interop is a step towards helping you build consistent UI's.
...
Over the last few years, design systems have become more popular than ever. One of its core goals is the ability to build UI's based on a set of predefined tokens. Interop allows you to define your tokens and seamelessly consume them. No third-party libraries or plugins required.
