...
Both `@stitches/core` and `@stitches/react` libraries combined weigh in at ~5.0kb gzipped.
...
Stitches lets you configure [conditions](/docs/responsive-styles) and apply variants responsively using the `css` prop. CSS at-rules can also be used inline if needed.
