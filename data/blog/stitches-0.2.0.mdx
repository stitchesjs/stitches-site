...
- [#473](https://github.com/stitchesjs/stitches/issues/473) - Fixed specificity issue with inherited variants & variants leaking as DOM attributes.
- [#474](https://github.com/stitchesjs/stitches/issues/474) - Fixed specificity issue when components would share the same style.
- [#483](https://github.com/stitchesjs/stitches/issues/483) - Fixed responsive variants not respecting usage order.
- [#492](https://github.com/stitchesjs/stitches/issues/492) - Fixed default variants being ignored when responsively applying variants.
- [#523](https://github.com/stitchesjs/stitches/issues/523) - Fixed flash of unstyled content after upgrading from alpha to beta.
- [#532](https://github.com/stitchesjs/stitches/issues/532) - Fixed variant props being passed down to DOM elements.
- [#535](https://github.com/stitchesjs/stitches/issues/535) - Fixed performance degradation after migrating from alpha to beta.
- [#563](https://github.com/stitchesjs/stitches/issues/563) - Fixed resulting CSS from custom `theme` / `globals` not appending if parameters were the same.
- [#586](https://github.com/stitchesjs/stitches/issues/586) - Fixed inconsistent use of `prefix`.
- [#588](https://github.com/stitchesjs/stitches/issues/588) - Fixed `backdropFilter` not transforming locally-scoped tokens in `css()`.
- [#622](https://github.com/stitchesjs/stitches/issues/622) - Fixed ability to set new default variants when composing components.
