...
We've written a dedicated blog post about the differences between styled-components and Stitches. You can [read it here](/blog/migrating-from-styled-components-to-stitches).

### Migrating from Emotion to Stitches

We've written a dedicated blog post about the differences between Emotion and Stitches. You can [read it here](/blog/migrating-from-emotion-to-stitches).
...
If you [look at the code on GitHub](https://github.com/stitchesjs/stitches-site), you'll see that behind the scenes it's using components coming from the [Modulz design system](https://github.com/radix-ui/design-system).
