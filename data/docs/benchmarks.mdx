...
## The tests
We've put together a test suite to test a range of perfomance factors across multiple CSS-in-JS libraries. All tests use object notation. Just like Stitches, our [benchmark tests](https://github.com/modulz/stitches-bench) are also open-source.
...
## Summary
Our benchmarks compare against styled-components and Emotion because they're the most popular CSS-in-JS libraries, and they've pushed us to improve our performance. Our goal with these benchmarks is to provide transparent performance comparisons for the community. If you'd like us to include your CSS-in-JS library, or think the tests could be improved, please open an issue.
